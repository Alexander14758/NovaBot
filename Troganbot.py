...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
           ...
           # "🔴 <b>Sell Token</b>\n\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    InlineKeyboardButton("↻ Refresh", callback_data="back_main"),
                 ]
                 ]
            ),
        )
    ...
    if option == "show_bot_guide":
        await _del()
        guide_text = (
            "<u><b>How do I use Trojan?</b></u>\n\n"
            "Check out our Youtube playlist where we explain it all and join our support chat for additional resources @trojantrading.\n\n"
            "Where can I find my referral code?\n"
            "Open the /start menu and click 💰Referrals.\n\n"
            "<u>What are the fees for using Trojan?</u>\n\n"
            ...
            "<u>Security Tips: How can I protect my account from scammers?</u>\n\n"
            ...
            "<u>Trading Tips: Common Failure Reasons</u>\n\n"
            ...
            "<u>My PNL seems wrong, why is that?</u>\n\n"
            ...
            "<u>Additional questions or need support?</u>\n\n"
            "Join our Telegram group @trojantrading and one of our admins can assist you."
        )
        await query.message.reply_text(
            guide_text,
            parse_mode="HTML",
    ...
    if option == "refer_earn":
        ...
        refer_text = (
            ...
            f"• Users referred: {total_invited}\n"
            f"• Direct: 0, Indirect: 0\n"
             f"• Earned rewards: 0 SOL ($0.00)\n\n"
             f"Cashback Rewards\n"
             f"• Earned rewards: 0 SOL ($0.00)\n\n"
             f"Total Rewards\n"
             f"•Total paid: 0 SOL ($0.00)\n"
             f"•Total unpaid: 0 SOL ($0.00)\n\n"
            f"<u>Your Referral Link</u>\n"
...
def main_menu_inline():
    ...
    [
        ...
        [
            InlineKeyboardButton("Position", callback_data="show_wallet"),
            InlineKeyboardButton("Limit Order", callback_data="show_limit_order"),
            InlineKeyboardButton("DCA Orders", callback_data="show_dca_order"),
        ],
        [
            InlineKeyboardButton(
                "Copy Trade",
                callback_data="ct_wallet_view",
            ),
            InlineKeyboardButton("Sniper", callback_data="show_limit_order"),
        ],
        [
            InlineKeyboardButton(
                "Scanner",
                url="https://t.me/tokenscan",
            ),
            InlineKeyboardButton("💰 Reward", callback_data="refer_earn"),
            InlineKeyboardButton("⭐ Watchlist", callback_data="show_live_chart"),
        ],
        [
            InlineKeyboardButton("Withdraw", callback_data="show_limit_order"),
            InlineKeyboardButton("Settings", callback_data="show_limit_order"),
        ],
        [
            InlineKeyboardButton("Help", callback_data="show_bot_guide"),
            InlineKeyboardButton("↻ Refresh", callback_data="show_refresh"),
        ],
    ]
)
...
def format_token_details(pair_data, wallet_balance=0, chain_sym="SOL"):
    ...
    try:
        ...
        message = (
            f"Buy ${token_name} — ({token_symbol}) 📈 • 🫧\n"
            f"<code>{token_address}</code>\n\n"
            f"Share token with your Reflink\n"
           #f"💳 <b>Wallet:</b>\n"
            f"Balance: {wallet_balance} {chain_sym} — W1✏️\n"
            f"Price: {price_str} — LIQ:{liq_str} — MC:{mcap_str}\n"
            f"Renounced {twitter_link}\n\n"
            f"🔴 Insufficient balance for buy amount + gas "
                ...
                buy_sell_keyboard = InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                f"← Back ",
                                callback_data="back_trade",
                            ),
                            InlineKeyboardButton(
                                "↻ Refresh", callback_data=f"sell_50_{token_address}"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
